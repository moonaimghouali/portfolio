  ...
  return (
    <div className='bg-neutral-900 rounded-md w-11/12 md:w-4/6 flex flex-col md:flex-row '>
      ...
      <div className='p-3 flex flex-col gap-1 text-white'>
        ...
        <p className='text-neutral-300 text-sm my-1'>{p.description}</p>
        ...
        <div className='flex flex-row gap-2'>
          {p.screens.map((image)=>(
            <Image key={p.id} src={'/../../../public/photo.jpg'} width={20} height={50} alt='image' className='w-20 apsect-[1/4] bg-white rounded-md'/>
          ))}
        </div>
